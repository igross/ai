...
This standard governs brainstorming and pre-paper planning when active work is in `projects/<name>/notes/`.
...
```powershell
&_shared/scripts/organize_notes.ps1 -ProjectPaths projects/05_learning_by_viewing,projects/06_accents_and_dialects
```
