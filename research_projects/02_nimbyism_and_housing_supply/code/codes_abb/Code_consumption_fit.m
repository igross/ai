...
% This code simulates the consumption model given parameter estimates

% The code uses 'data_hermite_cons2.mat'
...
%  Marginal propensity to consume out of assets (logs)
