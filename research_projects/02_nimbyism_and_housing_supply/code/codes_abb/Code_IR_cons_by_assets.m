...
% This code simulates impulse responses for income and consumption, for
% different ages and initial assets
% The results are obtained by varying tau_init and tau_shock, aa_ref and nage 
...
% For Figure 9 when acc=2, for Figure S34 top when acc=1
if tau_shock==.1
    figure
