...
by year, sort: summarize totly totcons tot_assets3, det

log close



saveold first_stage_regs, replace 
sort person year
order utoty uc ua age 
outsheet utoty uc ua age using first_stage_regs, nonames replace
